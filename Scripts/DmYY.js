...
class DmYY {
	...
	alignColumns = {
		/**
		 *  右对齐，水平方向排列
		 * @param alignmentStack
		 * @param marginRight
		 * @returns {WidgetStack}
		 */
		alignRightStack(alignmentStack, marginRight) {
		 ...
		 * @returns {WidgetStack}
		 */
		alignLeftStack(alignmentStack, marginLeft) {
			let contentStack = alignmentStack.addStack();
			contentStack.layoutHorizontally();
		 ...
		 * @returns {WidgetStack}
		 */
		alignTopStack(alignmentStack, marginTop) {
			let contentStack = alignmentStack.addStack();
		 ...
		 * @returns {WidgetStack}
		 */
		alignBottomStack(alignmentStack, marginBottom) {
			let contentStack = alignmentStack.addStack();
			contentStack.layoutVertically();
			contentStack.addSpacer();
		 ...
		 * @returns {WidgetStack}
		 */
		alignHorizontallyCenterStack(alignmentStack) {
		 ...
		 * @returns {WidgetStack}
		 */
		alignVerticallyCenterStack(alignmentStack) {
			let returnStack = alignmentStack.addStack();
			returnStack.layoutVertically();
			returnStack.centerAlignContent();
			return returnStack;
