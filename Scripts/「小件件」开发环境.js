...
class Base {
  ...
  init(widgetFamily = config.widgetFamily) {
    ...
    this.SETTING_KEY = this.md5(
      Script.name() + "@" + this.widgetFamily + "@" + this.arg
    );
    ...
    this.BACKGROUND_KEY1 = this.FILE_MGR_LOCAL.joinPath(
      this.FILE_MGR_LOCAL.documentsDirectory(),
      `bg_${this.SETTING_KEY1}.jpg`
    );
    this.BACKGROUND_KEY2 = this.FILE_MGR_LOCAL.joinPath(
      this.FILE_MGR_LOCAL.documentsDirectory(),
      `bg_${this.SETTING_KEY2}.jpg`
    );
    // 插件设置
